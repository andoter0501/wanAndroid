...
export class HomeViewModel {
    ...
    async init(): Promise<void> {
        ...
        try {
            ...
            this.popularWenda = sideResults[2].status === 'fulfilled' ? sideResults[2].value : [];
