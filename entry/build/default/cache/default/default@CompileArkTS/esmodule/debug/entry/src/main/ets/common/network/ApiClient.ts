...
export class ApiClient {
    ...
    private async sendRequest(request: http.HttpRequest, url: string, method: RequestMethod, body: string | undefined): Promise<http.HttpResponse> {
        return await new Promise<http.HttpResponse>((resolve, reject) => {
            request.request(url, {
                method: this.toHttpMethod(method),
                header: this.buildHeaders(url),
                extraData: body,
